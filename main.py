from graphs import countries_top_sales, countries_top_subs, \
    most_used_recurrences, top_payment_methods, top_niches, top_creators, year_by_year_total_sales, \
    year_by_year_total_subs, month_sales_2023, month_subscriptions_2023, top_niches_sales, product_format_count, \
    product_format_sales
...
if __name__ == '__main__':
    ...
    while True:
        ...
        print("\n1 - Countries with the most sales"
              ...
              "\n12 - Number of products by format"
              "\n13 - Number of sales by format"
              "\n0 - Exit")
        ...
        if graph_chosen == "0":
            ...
            product_format_count(csv_file_path)
        elif graph_chosen == "13":
            product_format_sales(csv_file_path)
        else:
